      ...
      <div className="grid mt-6 col-span-2 md:grid-cols-2 gap-10 md:gap-4 ">
        <div className="">
          ...
          <div className="flex flex-col text-base">
            <p className="py-2">
              ...
              <span className="text-orange-400">Payme</span> | Founder at{" "}
        ...
        <div className="w-full h-full p-[80px] sm:p-[100px] pt-2  sm:pt-0 ">
          <Image
            ...
            height={1000}
            src={
              "https://media.licdn.com/dms/image/v2/D4D03AQGzrGBXON_KUQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1718193574804?e=1731542400&v=beta&t=U26uM-32lkJaam9bZMCuWCyhWtUWv3ZjW8wvtqiFrAQ"
            }
          />
        </div>
      </div>

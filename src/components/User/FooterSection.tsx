...
const FooterSection = () => {
  return (
    <div id='contact' className='pb-20 flex items-center justify-center flex-col'>
        <p className='md:text-4xl font-bold'>Stay in touch.</p>
        <p className='text-sm opacity-50 mt-2'>I enjoy working on mobile and web development projects. </p>
        <p className='text-sm opacity-50'>Don’t hesitate to get in touch and share more about your ideas. </p>
